...
namespace TheCave
{
    public partial class A0500_MAINTAINYOURPROFILE : System.Web.UI.Page
    {
        ...
        protected void loadMemberProfile()
        {
            ...
            sqlDa.SelectCommand.Parameters.AddWithValue("@MemberID", Session["CurMemberID"]);
        ...
        public void UpdateMemberOfFamily(SqlConnection sqlCon)
        {
            //int MemberID = Convert.ToInt32((sender as LinkButton).CommandArgument.Trim();
            SqlCommand sqlCmd = new SqlCommand("UpdateCurrentMember", sqlCon);
            sqlCmd.CommandType = CommandType.StoredProcedure;
            sqlCmd.Parameters.AddWithValue("@MemberID", Session["CurMemberID"]);
            sqlCmd.Parameters.AddWithValue("@Fname", name.Text.Trim());
            sqlCmd.Parameters.AddWithValue("@LName", surname.Text.Trim());
            sqlCmd.Parameters.AddWithValue("@Gender", drop1.Text.Trim());
            sqlCmd.Parameters.AddWithValue("@Deceased", drop2.Text.Trim());
