<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="A0500_MAINTAINPROFILE.aspx.cs" Inherits="TheCave.A0500_MAINTAINPROFILE" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

  
    <h2 class="text-center"><%: Title %>Maintain Your CAVE Profile</h2>
    <h3>Click <B>Select Profile</B>to display all members of your CAVE.</h3>
        <h4>Click <b>view</b> to start updating the corresponding member's profile.</h4>
    <br />
    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Select Profile" />
    <asp:Button ID="Button2" runat="server" Text="Minimise View" OnClick="Button2_Click" />

    <br />

    <asp:HiddenField ID="HiddenField2" runat="server" OnValueChanged="HiddenField2_ValueChanged" />
                  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns ="False" Height="26px" Width="596px" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
    ...
    <br />
    <br />
    <h3> Complete the form below to <b>Add/Update</b> member's details.</h3>
    <br />
                        ...
                        <td style="width: 151px">
                         ...
                         <td style="width: 258px">
                             <asp:TextBox ID="email1" runat="server" Width="214px"></asp:TextBox>
                              <%--<asp:RequiredFieldValidator ID="RequiredFieldValidatorEmail" runat="server" ErrorMessage="Please Enter Valid Email Address" ForeColor ="Red" ControlToValidate="email1"></asp:RequiredFieldValidator>--%>
                             *</td>
                        <td style="width: 258px">&nbsp;</td>
                    </tr>
                        <tr>
        ...
        <asp:View ID="View3" runat="server">
                ...
                <table>
                   ...
                   <td colspan="2" style="height: 24px; width: 322px;" class="text-right">
                       ...
                       <asp:Button ID="btnSave" runat="server" Font-Names="Arial" OnClick="btnSave_Click" Text="Save" Width="77px" />
